...
def main():
  ...
  parser.add_argument(
    "--train_language", default="enes", type=str, help="Train language if is different of the evaluation language."
  )

  # adding dev language for selecting the best model
  parser.add_argument(
    "--dev_language", default="enes", type=str, help="Dev language for selecting the best model."
  )
  parser.add_argument(
