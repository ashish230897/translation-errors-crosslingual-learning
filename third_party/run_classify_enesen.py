...
def main():
  ...
  parser.add_argument(
    "--train_language", default="enesen", type=str, help="Train language if is different of the evaluation language."
  )

  # adding dev language for selecting the best model
  parser.add_argument(
    "--dev_language", default="enesen", type=str, help="Dev language for selecting the best model."
  )
  parser.add_argument(
    "--predict_languages", type=str, default="hi", help="prediction languages separated by ','."
  )
  parser.add_argument(
    "--output_dir",
    default=None,
